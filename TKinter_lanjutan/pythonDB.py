...
uiApp = tk.Tk()                           
uiApp.configure(background='light blue')                                         
uiApp.geometry("800x1000")                                                       
uiApp.resizable()                                                                
uiApp.title("Prediksi Fakultas")                                                 
...
#menggunakan label
inputLabel = ttk.Label(inputFrame, text="Prediksi Fakultas")                     
inputLabel.pack(padx=10, pady=10, fill="x", expand=True)                         

#input nama siswa
labelInputNama = ttk.Label(inputFrame, text="Nama Siswa")                        
...
#input nilai 
labelInputBiologi = ttk.Label(inputFrame, text="nilai Biologi")
...
labelInputFisika = ttk.Label(inputFrame, text="nilai fisika")
...
labelInputInggris = ttk.Label(inputFrame, text="nilai bahasa inggris")
